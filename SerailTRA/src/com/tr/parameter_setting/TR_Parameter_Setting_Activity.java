...
*
 */
public class TR_Parameter_Setting_Activity extends BaseBottomMenuActivity implements TabListener{
...
//	public static boolean machanicalParameter=true;//解决切换tab时自动再次判断checkbox的bug；
	...
	public int getContentViewLayoutResId() { return R.layout.tr_parameter_setting; }
		 	 ...
		 	 case 11:  //HOME
		 		//有警报
			 		 if(WifiSetting_Info.alarmFlag==1){
			 			KeyCodeSend.send(996, TR_Parameter_Setting_Activity.this);
			 		 }else{
		 		new Thread() {
					public void run() {
