			...
			public View getView(int position, View convertView, ViewGroup parent) {
				...
				if (appInfo != null) {
					...
					if (position == 0) {
						...
						NewPragramActivity.PosccalmRunnable.setTextView(holder.line_fp_setting,holder.BA_fp_setting,holder.UD_fp_setting,null,null);
							...
							.setPositiveButton(R.string.OK,
									new DialogInterface.OnClickListener() {
										...
										public void onClick(DialogInterface arg0,int arg1) {
											...
											byte[] temp1=new byte[4*8];
											System.arraycopy(HexDecoding.int2byteArray4(0x7FFFFFFF), 0, temp1, 0, 4);
									        System.arraycopy(HexDecoding.int2byteArray4(0x7FFFFFFF), 0, temp1, 4, 4);
									        System.arraycopy(HexDecoding.int2byteArray4(0x7FFFFFFF), 0, temp1, 8, 4);
									        System.arraycopy(HexDecoding.int2byteArray4(0x7FFFFFFF), 0, temp1, 12, 4);
									        System.arraycopy(HexDecoding.int2byteArray4(0x7FFFFFFF), 0, temp1, 16, 4);
									        System.arraycopy(HexDecoding.int2byteArray4(0x7FFFFFFF), 0, temp1, 20, 4);
									        System.arraycopy(HexDecoding.int2byteArray4(0x7FFFFFFF), 0, temp1, 24, 4);
									        System.arraycopy(HexDecoding.int2byteArray4(0x7FFFFFFF), 0, temp1, 28, 4);
											for(int i=0;i<packCnt;i++){
												 System.arraycopy(temp1, 0, temppos, i*32, 32);
											}
