...
public class Fragments_Action extends Fragment {
	...
	public  void downPragram()
   {
	...
	new AlertDialog.Builder(getActivity())
	.setTitle("提示").setMessage("确定切换到手动状态并下载吗？")
...
//	    	final ArrayAdapter<String> NullAdapter= new ArrayAdapter<String>(orderView.getContext(),android.R.layout.simple_spinner_item,NullList);
	    ...
	    public void zsoperate(int position){
	    	...
	    	AlertDialog dialog2=new AlertDialog.Builder(getActivity())
			 ...
			 .setView(orderView)
			 .setPositiveButton(R.string.OK,//确定 
					 new ActionOrderListener (boxList,position,"OUT",NcEditList,MyAdapter.this,mListView))//使用单独创建的类控制详细命令界面的响应!!!											
			 .setNegativeButton("取消", null).show();
		...
		public void zjoperate(int position){
	    	...
	    	AlertDialog dialog2=new AlertDialog.Builder(getActivity())
			 ...
			 .setView(orderView)
			 .setPositiveButton(R.string.OK,//确定 
					 new ActionOrderListener(itemList,position,"OUTP",NcEditList,MyAdapter.this,mListView,false))//使用单独创建的类控制详细命令界面的响应!!!											
			 .setNegativeButton("取消", null).show();
		...
		public void zsjxhoperate(int position){
	    	...
	    	AlertDialog dialog2=new AlertDialog.Builder(getActivity())
			 ...
			 .setView(orderView)
			 .setPositiveButton(R.string.OK,//确定 
					 new ActionOrderListener (itemList,position,"PARALLEL",NcEditList,MyAdapter.this,mListView,false))//使用单独创建的类控制详细命令界面的响应!!!											
			 .setNegativeButton("取消", null).show();
			 //.setContentView(R.layout.nc_listrowcontent);
...
//  	    		}
	    	...
	    	AlertDialog dialog2=new AlertDialog.Builder(getActivity())
			 ...
			 .setView(orderView)
			 .setPositiveButton(R.string.OK,//确定 
					 new ActionOrderListener (boxList,position,"IF",NcEditList,MyAdapter.this,mListView))//使用单独创建的类控制详细命令界面的响应!!!											
			 .setNegativeButton("取消", null).show();
			 //.setContentView(R.layout.nc_listrowcontent);
