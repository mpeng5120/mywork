...
public class DetailedOrderListener1 implements OnClickListener {
    private View view;
    ...
    public DetailedOrderListener1(View orderview, int pos, String order_array,ArrayList<HashMap<String, Object>> NcEditList,MyAdapter myAdapter) {
	// TODO 自动生成的构造函数存根
	view = orderview;
	position = pos;
