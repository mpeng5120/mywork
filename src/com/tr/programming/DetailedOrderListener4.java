...
import com.tr.R;
import com.tr.programming.Fragments_NCedit4.MyAdapter;
...
public class DetailedOrderListener4 implements OnClickListener {
    private View view;
    ...
    public DetailedOrderListener4(View orderview, int pos, String order_array,ArrayList<HashMap<String, Object>> NcEditList,MyAdapter myAdapter) {
	// TODO 自动生成的构造函数存根
	view = orderview;
	position = pos;
