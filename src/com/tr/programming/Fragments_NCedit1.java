...
public class Fragments_NCedit1 extends Fragment {
	...
	ArrayList<HashMap<String, Object>> NcEditList = ArrayListBound.getNCeditList1Data();
	...
	public static ArrayList<HashMap<String, Object>> selectNcEditList=new ArrayList<HashMap<String, Object>>();//被选中待粘贴的代码
	...
	public void showNote(){
		try{
			NcEditList= ArrayListBound.getNCeditList1Data();
	...
	public void onCreate(Bundle savedInstanceState) {
		System.out.println("Fragments_NCedit1--->onCreate");
		try{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		System.out.println("Fragments_NCedit1--->onCreateView");
	...
	public void onResume() {
		...
		/***************************************************************/
		System.out.println("Fragments_NCedit1  alarmQueryRunnable");
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		System.out.println("Fragments_NCedit1--->onActivityCreated");
								...
								new DialogInterface.OnClickListener() { // 添加选择某项后的方法
									...
									public void onClick(DialogInterface dialog,int which) { 
										...
										case 0:	//剪切
											...
											if(selectcount==0){
												if(selectNcEditList==null){return;}
												selectNcEditList.clear();
												selectNcEditList.add(NcEditList.get(position));
											...
											for(int i=0;i<selectcount;i++){
											   selectNcEditList.add(NcEditList.get(selects[i]));
											}
										...
										case 2://粘贴
											...
											for(int i=0;i<selectNcEditList.size();i++){
											int nextposition=(position+i);
											HashMap<String, Object> map2 = new HashMap<String, Object>();
											map2.put("addressText",	String.format("%04d", nextposition));//
											map2.put("numSpinner",selectNcEditList.get(i).get("numSpinner"));
											map2.put("orderSpinner",selectNcEditList.get(i).get("orderSpinner"));
											map2.put("operatText",selectNcEditList.get(i).get("operatText"));
											map2.put("noteEditText",selectNcEditList.get(i).get("noteEditText"));
										...
										case 6://撤销
											if(oldNcEditLists.size()<=0){
												...
												newNcEditLists.add(newNcEditList);
													...
													ArrayList<HashMap<String, Object>> newNcEditList1=new ArrayList<HashMap<String, Object>>();//撤销、恢复使用
													NcEditList.clear();
													for(int m=0;m<(oldNcEditLists.get(oldNcEditLists.size()-1)).size();m++){
														...
														newNcEditList1.add(m,map2);
														NcEditList.add(m,map2);
													}
													newNcEditLists.add(newNcEditList1);
...
//				convertView = mInflater.inflate(R.layout.nc_edit_item,null);
			...
			if (appInfo != null) {
				...
				String numSpinner = (String)appInfo.get(keyString[1]);
										...
										if (editString.length()!=0) {
											if (radioGroupLS.getCheckedRadioButtonId()==R.id.radioL) {
												...
												int data = Integer.parseInt(editString);
												 if(data<=0||data>9){
													 Toast.makeText(getActivity(), "输入范围1~9", Toast.LENGTH_SHORT).show(); 
													 return;
												 }
											}
...
//						spinnerFP_MOVE.setAdapter(NullAdapter);		
	    	...
	    	AlertDialog dialog2=new AlertDialog.Builder(getActivity())
			 ...
			 .setPositiveButton(R.string.OK,//确定 
					 new DetailedOrderListener1 (orderView,position,oper,NcEditList,MyAdapter.this))//使用单独创建的类控制详细命令界面的响应!!!											
...
//						radioSET_IF.setClickable(true);
	    	...
	    	buttonCancel_IF.setOnClickListener(new android.view.View.OnClickListener() {//撤销输入	
			 ...
			 .setCancelable(false)//点击框外不消失
			 .setPositiveButton(R.string.OK,//确定 
					 new DetailedOrderListener1 (orderView,position,"IF",NcEditList,MyAdapter.this))//使用单独创建的类控制详细命令界面的响应!!!											
			 .setNegativeButton("取消", null).setNeutralButton("指令表", new DialogInterface.OnClickListener() { 
                 public void onClick(DialogInterface dialog, int which) {
                	 try{
                		 selectoperate(qxposition); 
...
//						radioSET_OUT.setClickable(true);
	    	...
	    	AlertDialog dialog2=new AlertDialog.Builder(getActivity())
			 ...
			 .setCancelable(false)//点击框外不消失
			 .setPositiveButton(R.string.OK,//确定 
					 new DetailedOrderListener1 (orderView,position,"OUT",NcEditList,MyAdapter.this))//使用单独创建的类控制详细命令界面的响应!!!											
			 .setNegativeButton("取消", null).setNeutralButton("指令表", new DialogInterface.OnClickListener() { 
                 public void onClick(DialogInterface dialog, int which) {
                	 selectoperate(qxposition);
                 }  
		...
		/*	symbolList_WAIT.clear();
			...
			AlertDialog dialog2=new AlertDialog.Builder(getActivity())
			 ...
			 .setCancelable(false)//点击框外不消失
			 .setPositiveButton(R.string.OK,//确定 
					 new DetailedOrderListener1 (orderView,position,"WAIT",NcEditList,MyAdapter.this))//使用单独创建的类控制详细命令界面的响应!!!											
			 .setNegativeButton("取消", null).setNeutralButton("指令表", new DialogInterface.OnClickListener() { 
                 public void onClick(DialogInterface dialog, int which) {
                	 selectoperate(qxposition);
                 }  
...
//	    	final RadioButton radioCALL_IFThen=(RadioButton) orderView .findViewById(R.id.radioCALL_IFThen);
	    	...
	    	AlertDialog dialog2=new AlertDialog.Builder(getActivity())
			 ...
			 .setCancelable(false)//点击框外不消失
			 .setPositiveButton(R.string.OK,//确定 
					 new DetailedOrderListener1 (orderView,position,"IFThen",NcEditList,MyAdapter.this))//使用单独创建的类控制详细命令界面的响应!!!											
			 .setNegativeButton("取消", null).setNeutralButton("指令表", new DialogInterface.OnClickListener() { 
                 public void onClick(DialogInterface dialog, int which) {
                	 selectoperate(qxposition);
                 }  
	    ...
	    public void alarmoperate(int position){
	    	...
	    	AlertDialog dialog2=new AlertDialog.Builder(getActivity())
			 ...
			 .setCancelable(false)//点击框外不消失
			 .setPositiveButton(R.string.OK,//确定 
					 new DetailedOrderListener1 (orderView,position,"ALARM",NcEditList,MyAdapter.this))//使用单独创建的类控制详细命令界面的响应!!!											
			 .setNegativeButton("取消", null).setNeutralButton("指令表", new DialogInterface.OnClickListener() { 
                 public void onClick(DialogInterface dialog, int which) {
                	 selectoperate(qxposition);
                 }  
		...
		/*	symbolList_Counter.clear();
	    	...
	    	AlertDialog dialog2=new AlertDialog.Builder(getActivity())
			 ...
			 .setCancelable(false)//点击框外不消失
			 .setPositiveButton(R.string.OK,//确定 
					 new DetailedOrderListener1 (orderView,position,"COUNTER",NcEditList,MyAdapter.this))//使用单独创建的类控制详细命令界面的响应!!!											
			 .setNegativeButton("取消", null).setNeutralButton("指令表", new DialogInterface.OnClickListener() { 
                 public void onClick(DialogInterface dialog, int which) {
                	 selectoperate(qxposition);
                 }  
	    ...
	    public void sequentialoperate(int position){
	    	...
	    	AlertDialog dialog2=new AlertDialog.Builder(getActivity())
			 ...
			 .setCancelable(false)//点击框外不消失
			 .setPositiveButton(R.string.OK,//确定 
					 new DetailedOrderListener1 (orderView,position,"SEQUENTIAL",NcEditList,MyAdapter.this))//使用单独创建的类控制详细命令界面的响应!!!											
			 .setNegativeButton("取消", null).setNeutralButton("指令表", new DialogInterface.OnClickListener() { 
                 public void onClick(DialogInterface dialog, int which) {
                	 selectoperate(qxposition);
                 }  
	    ...
	    public void paralleloperate(int position){
	    	...
	    	AlertDialog dialog2=new AlertDialog.Builder(getActivity())
			 ...
			 .setCancelable(false)//点击框外不消失
			 .setPositiveButton(R.string.OK,//确定 
					 new DetailedOrderListener1 (orderView,position,"PARALLEL",NcEditList,MyAdapter.this))//使用单独创建的类控制详细命令界面的响应!!!											
			 .setNegativeButton("取消", null).setNeutralButton("指令表", new DialogInterface.OnClickListener() { 
                 public void onClick(DialogInterface dialog, int which) {
                	 selectoperate(qxposition);
                 }  
...
//							 View view18=View.inflate(getActivity(), R.layout.nc_order_end,null );
							 switch (Constans.NCorders_enum.getOrder(nc_orders[which])) {
								case OUTP:
									orderView=View.inflate(getActivity(), R.layout.nc_order_outp,null );
									 ...
									 .setCancelable(false)//点击框外不消失
									 .setPositiveButton(R.string.OK,//确定 
											 new DetailedOrderListener1 (orderView,position,nc_orders[which],NcEditList,MyAdapter.this))//使用单独创建的类控制详细命令界面的响应!!!											
								...
								case PAUSE:
									...
									ArrayListBound.getNCeditList1Data().get(position).put("operatText", "");
									 dialog2=new AlertDialog.Builder(getActivity())
									 .setTitle(endretpausetitle)
									 .setView(orderView)
									 .setCancelable(false)//点击框外不消失
									 .setPositiveButton(R.string.OK,//确定 
											 new DetailedOrderListener1 (orderView,position,nc_orders[which],NcEditList,MyAdapter.this))//使用单独创建的类控制详细命令界面的响应!!!											
	...
	public static void updateSEQList(ArrayList<String> gotoList,ArrayList<String> callList) {
		try{
		gotoList.clear();
		callList.clear();
		for (int i = 0; i < ArrayListBound.getNCeditList1Data().size(); i++) {
			String lableString=  ArrayListBound.getNCeditList1Data().get(i).get("numSpinner").toString().trim();
			if (lableString.contains("L")) {
				gotoList.add(lableString);
			}else if (lableString.contains("S")) {
				callList.add(lableString);
			}
		}	
		
		for (int i = 0; i < ArrayListBound.getNCeditList2Data().size(); i++) {
			String lableString=  ArrayListBound.getNCeditList2Data().get(i).get("numSpinner").toString().trim();
			if (lableString.contains("L")) {
				gotoList.add(lableString);
			}else if (lableString.contains("S")) {
				callList.add(lableString);
		...
		for (int i = 0; i < ArrayListBound.getNCeditList3Data().size(); i++) {
			String lableString=  ArrayListBound.getNCeditList3Data().get(i).get("numSpinner").toString().trim();
			if (lableString.contains("L")) {
				gotoList.add(lableString);
			}else if (lableString.contains("S")) {
				callList.add(lableString);
		...
		for (int i = 0; i < ArrayListBound.getNCeditList4Data().size(); i++) {
			String lableString=  ArrayListBound.getNCeditList4Data().get(i).get("numSpinner").toString().trim();
			if (lableString.contains("L")) {
				gotoList.add(lableString);
			}else if (lableString.contains("S")) {
				callList.add(lableString);
		...
		for (int i = 0; i < ArrayListBound.getNCeditList5Data().size(); i++) {
			String lableString=  ArrayListBound.getNCeditList5Data().get(i).get("numSpinner").toString().trim();
			if (lableString.contains("L")) {
				gotoList.add(lableString);
			}else if (lableString.contains("S")) {
				callList.add(lableString);
		...
		for (int i = 0; i < ArrayListBound.getNCeditList6Data().size(); i++) {
			String lableString=  ArrayListBound.getNCeditList6Data().get(i).get("numSpinner").toString().trim();
			if (lableString.contains("L")) {
				gotoList.add(lableString);
			}else if (lableString.contains("S")) {
				callList.add(lableString);
		...
		for (int i = 0; i < ArrayListBound.getNCeditList7Data().size(); i++) {
			String lableString=  ArrayListBound.getNCeditList7Data().get(i).get("numSpinner").toString().trim();
			if (lableString.contains("L")) {
				gotoList.add(lableString);
			}else if (lableString.contains("S")) {
				callList.add(lableString);
		...
		for (int i = 0; i < ArrayListBound.getNCeditList8Data().size(); i++) {
			String lableString=  ArrayListBound.getNCeditList8Data().get(i).get("numSpinner").toString().trim();
			if (lableString.contains("L")) {
				gotoList.add(lableString);
			}else if (lableString.contains("S")) {
				callList.add(lableString);
	...
	public static void updatePARList(ArrayList<String> qonList,ArrayList<String> qoffList) {
		try{
		qonList.clear();
		qoffList.clear();
		for (int i = 0; i < ArrayListBound.getNCeditList1Data().size(); i++) {
			String lableString=  ArrayListBound.getNCeditList1Data().get(i).get("numSpinner").toString().trim();
			if (lableString.contains("Q")) {
				qonList.add(lableString);
			}
            if (lableString.contains("Q")) {
				qoffList.add(lableString);
			}
		}
		for (int i = 0; i < ArrayListBound.getNCeditList2Data().size(); i++) {
			String lableString=  ArrayListBound.getNCeditList2Data().get(i).get("numSpinner").toString().trim();
