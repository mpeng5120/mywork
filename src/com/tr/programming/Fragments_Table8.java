...
public class Fragments_Table8 extends Fragment {

	private ListView mListView;
	DecimalFormat format = new DecimalFormat("####");// 格式转化类,0001的格式，暂时这么做了，以后找到更好的方法可以替换
	ArrayList<HashMap<String, Object>> TableEditList = ArrayListBound.getTableList8Data();
	...
	public void showNote(){
		try{
			TableEditList = ArrayListBound.getTableList8Data();
	...
	public void onResume() {
		...
		//TableWatch.beginWatch(mListView,ArrayListBound.getTableList8Data());
		TableWatch.listView=mListView;
		//TableWatch.TableEditList=ArrayListBound.getTableList8Data();
		/***************************************************************/
		System.out.println("Fragments_Table8  alarmQueryRunnable");
	...
	public void onCreate(Bundle savedInstanceState) {
		System.out.println("Fragments_Table8--->onCreate");
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		System.out.println("Fragments_Table8--->onCreateView");
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		System.out.println("Fragments_Table8--->onActivityCreated");
