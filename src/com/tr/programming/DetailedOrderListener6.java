...
import com.tr.R;
import com.tr.programming.Fragments_NCedit6.MyAdapter;
...
public class DetailedOrderListener6 implements OnClickListener {
    private View view;
    ...
    public DetailedOrderListener6(View orderview, int pos, String order_array,ArrayList<HashMap<String, Object>> NcEditList,MyAdapter myAdapter) {
	// TODO 自动生成的构造函数存根
	view = orderview;
	position = pos;
