...
public class Fragments_Table1 extends Fragment {

	private ListView mListView;
	DecimalFormat format = new DecimalFormat("####");// 格式转化类,0001的格式，暂时这么做了，以后找到更好的方法可以替换
	ArrayList<HashMap<String, Object>> TableEditList = ArrayListBound.getTableList1Data();
	...
	public void showNote(){
		try{
			TableEditList = ArrayListBound.getTableList1Data();
...
//			Config.isMutiThread = false; //add by mpeng 20141231
	...
	public void onResume() {
		...
		//TableWatch.beginWatch(mListView,ArrayListBound.getTableList1Data());
		TableWatch.listView=mListView;
		//TableWatch.TableEditList=ArrayListBound.getTableList1Data();
		/***************************************************************/
		System.out.println("Fragments_Table1  alarmQueryRunnable");
	...
	public void onCreate(Bundle savedInstanceState) {
		System.out.println("Fragments_Table1--->onCreate");
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		System.out.println("Fragments_Table1--->onCreateView");
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		System.out.println("Fragments_Table1--->onActivityCreated");
									...
									public void onClick(DialogInterface dialog,int which) { 
										...
										case 0:	//剪切
											...
											if(selectcount==0){
												...
												selectNcEditList.add(TableEditList.get(position));
											...
											for(int i=0;i<selectcount;i++){
											   selectNcEditList.add(TableEditList.get(selects[i]));
											}
										...
										case 2://粘贴
											...
											map2.put("inputEditText",selectNcEditList.get(i).get("inputEditText"));
											map2.put("outputEditText",selectNcEditList.get(i).get("outputEditText"));
    ...
    public void setListselected(List<Boolean> listselected) {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (appInfo != null) {
				...
				/*System.out.println("行数" + position+"    numText="+Integer.parseInt(numText));
