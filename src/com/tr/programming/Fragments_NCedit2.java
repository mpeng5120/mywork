...
public class Fragments_NCedit2 extends Fragment {
	...
	ArrayList<HashMap<String, Object>> NcEditList = ArrayListBound.getNCeditList2Data();
	...
	public void showNote(){
		try{
			NcEditList= ArrayListBound.getNCeditList2Data();
	...
	public void onCreate(Bundle savedInstanceState) {
		System.out.println("Fragments_NCedit2--->onCreate");
		try{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		System.out.println("Fragments_NCedit2--->onCreateView");
	...
	public void onResume() {
		...
		/***************************************************************/
		System.out.println("Fragments_NCedit2  alarmQueryRunnable");
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		System.out.println("Fragments_NCedit2--->onActivityCreated");
										...
										if (editString.length()!=0) {
											if (radioGroupLS.getCheckedRadioButtonId()==R.id.radioL) {
												...
												int data = Integer.parseInt(editString);
												 if(data<=10||data>19){
													 Toast.makeText(getActivity(), "输入范围11~19", Toast.LENGTH_SHORT).show(); 
													 return;
												 }
											}
...
//						spinnerFP_MOVE.setAdapter(NullAdapter);		
	    	...
	    	AlertDialog dialog2=new AlertDialog.Builder(getActivity())
			 ...
			 .setPositiveButton(R.string.OK,//确定 
					 new DetailedOrderListener2 (orderView,position,oper,NcEditList,MyAdapter.this))//使用单独创建的类控制详细命令界面的响应!!!											
...
//						radioSET_IF.setClickable(true);
	    	...
	    	buttonCancel_IF.setOnClickListener(new android.view.View.OnClickListener() {//撤销输入	
			 ...
			 .setCancelable(false)//点击框外不消失
			 .setPositiveButton(R.string.OK,//确定 
					 new DetailedOrderListener2 (orderView,position,"IF",NcEditList,MyAdapter.this))//使用单独创建的类控制详细命令界面的响应!!!											
			 .setNegativeButton("取消", null).setNeutralButton("指令表", new DialogInterface.OnClickListener() { 
                 public void onClick(DialogInterface dialog, int which) {
                	 selectoperate(qxposition);
                 }  
...
//						radioSET_OUT.setClickable(true);
	    	...
	    	AlertDialog dialog2=new AlertDialog.Builder(getActivity())
			 ...
			 .setCancelable(false)//点击框外不消失
			 .setPositiveButton(R.string.OK,//确定 
					 new DetailedOrderListener2 (orderView,position,"OUT",NcEditList,MyAdapter.this))//使用单独创建的类控制详细命令界面的响应!!!											
			 .setNegativeButton("取消", null).setNeutralButton("指令表", new DialogInterface.OnClickListener() { 
                 public void onClick(DialogInterface dialog, int which) {
                	 selectoperate(qxposition);
                 }  
		...
		/*	symbolList_WAIT.clear();
			...
			AlertDialog dialog2=new AlertDialog.Builder(getActivity())
			 ...
			 .setCancelable(false)//点击框外不消失
			 .setPositiveButton(R.string.OK,//确定 
					 new DetailedOrderListener2 (orderView,position,"WAIT",NcEditList,MyAdapter.this))//使用单独创建的类控制详细命令界面的响应!!!											
			 .setNegativeButton("取消", null).setNeutralButton("指令表", new DialogInterface.OnClickListener() { 
                 public void onClick(DialogInterface dialog, int which) {
                	 selectoperate(qxposition);
                 }  
...
//	    	final RadioButton radioCALL_IFThen=(RadioButton) orderView .findViewById(R.id.radioCALL_IFThen);
	    	...
	    	AlertDialog dialog2=new AlertDialog.Builder(getActivity())
			 ...
			 .setCancelable(false)//点击框外不消失
			 .setPositiveButton(R.string.OK,//确定 
					 new DetailedOrderListener2 (orderView,position,"IFThen",NcEditList,MyAdapter.this))//使用单独创建的类控制详细命令界面的响应!!!											
			 .setNegativeButton("取消", null).setNeutralButton("指令表", new DialogInterface.OnClickListener() { 
                 public void onClick(DialogInterface dialog, int which) {
                	 selectoperate(qxposition);
                 }  
	    ...
	    public void alarmoperate(int position){
	    	...
	    	AlertDialog dialog2=new AlertDialog.Builder(getActivity())
			 ...
			 .setCancelable(false)//点击框外不消失
			 .setPositiveButton(R.string.OK,//确定 
					 new DetailedOrderListener2 (orderView,position,"ALARM",NcEditList,MyAdapter.this))//使用单独创建的类控制详细命令界面的响应!!!											
			 .setNegativeButton("取消", null).setNeutralButton("指令表", new DialogInterface.OnClickListener() { 
                 public void onClick(DialogInterface dialog, int which) {
                	 selectoperate(qxposition);
                 }  
		...
		/*	symbolList_Counter.clear();
	    	...
	    	AlertDialog dialog2=new AlertDialog.Builder(getActivity())
			 ...
			 .setCancelable(false)//点击框外不消失
			 .setPositiveButton(R.string.OK,//确定 
					 new DetailedOrderListener2 (orderView,position,"COUNTER",NcEditList,MyAdapter.this))//使用单独创建的类控制详细命令界面的响应!!!											
			 .setNegativeButton("取消", null).setNeutralButton("指令表", new DialogInterface.OnClickListener() { 
                 public void onClick(DialogInterface dialog, int which) {
                	 selectoperate(qxposition);
                 }  
	    ...
	    public void sequentialoperate(int position){
	    	...
	    	AlertDialog dialog2=new AlertDialog.Builder(getActivity())
			 ...
			 .setCancelable(false)//点击框外不消失
			 .setPositiveButton(R.string.OK,//确定 
					 new DetailedOrderListener2 (orderView,position,"SEQUENTIAL",NcEditList,MyAdapter.this))//使用单独创建的类控制详细命令界面的响应!!!											
			 .setNegativeButton("取消", null).setNeutralButton("指令表", new DialogInterface.OnClickListener() { 
                 public void onClick(DialogInterface dialog, int which) {
                	 selectoperate(qxposition);
                 }  
	    ...
	    public void paralleloperate(int position){
	    	...
	    	AlertDialog dialog2=new AlertDialog.Builder(getActivity())
			 ...
			 .setCancelable(false)//点击框外不消失
			 .setPositiveButton(R.string.OK,//确定 
					 new DetailedOrderListener2 (orderView,position,"PARALLEL",NcEditList,MyAdapter.this))//使用单独创建的类控制详细命令界面的响应!!!											
			 .setNegativeButton("取消", null).setNeutralButton("指令表", new DialogInterface.OnClickListener() { 
                 public void onClick(DialogInterface dialog, int which) {
                	 selectoperate(qxposition);
                 }  
							 ...
							 switch (Constans.NCorders_enum.getOrder(nc_orders[which])) {
								case OUTP:
									orderView=View.inflate(getActivity(), R.layout.nc_order_outp,null );
									 ...
									 .setCancelable(false)//点击框外不消失
									 .setPositiveButton(R.string.OK,//确定 
											 new DetailedOrderListener2 (orderView,position,nc_orders[which],NcEditList,MyAdapter.this))//使用单独创建的类控制详细命令界面的响应!!!											
								...
								case PAUSE:
									...
									ArrayListBound.getNCeditList2Data().get(position).put("operatText", "");
									 dialog2=new AlertDialog.Builder(getActivity())
