...
public class Fragments_Table7 extends Fragment {

	private ListView mListView;
	DecimalFormat format = new DecimalFormat("####");// 格式转化类,0001的格式，暂时这么做了，以后找到更好的方法可以替换
	ArrayList<HashMap<String, Object>> TableEditList = ArrayListBound.getTableList7Data();
	...
	public void showNote(){
		try{
			TableEditList = ArrayListBound.getTableList7Data();
	...
	public void onResume() {
		...
		//TableWatch.beginWatch(mListView,ArrayListBound.getTableList7Data());
		TableWatch.listView=mListView;
		//TableWatch.TableEditList=ArrayListBound.getTableList7Data();
		/***************************************************************/
		System.out.println("Fragments_Table7  alarmQueryRunnable");
	...
	public void onCreate(Bundle savedInstanceState) {
		System.out.println("Fragments_Table7--->onCreate");
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		System.out.println("Fragments_Table7--->onCreateView");
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		System.out.println("Fragments_Table7--->onActivityCreated");
