...
#include "com_tr_SerailPort_SerialPortJNI.h"
...
/*
 * Class:     com_tr_SerailPort_serialclass_SerialPortJNI
 * Method:    setSpeed
 * Signature: (II)I
 ...
 */JNIEXPORT jobject JNICALL Java_com_tr_SerailPort_SerialPortJNI_openDev(
		JNIEnv *env, jobject thiz, jint devnum) {

	LOGD("mpeng openDev==>fun in");
	...
	jint fd = open(dev, O_RDWR); //O_NOCTTY | O_NDELAY
...
JNIEXPORT jobject JNICALL Java_com_tr_SerailPort_SerialPortJNI_open485Dev
  (JNIEnv *env, jobject thiz, jint devnum){
	return Java_com_tr_SerailPort_SerialPortJNI_openDev(env,  thiz,  devnum);
}
...
JNIEXPORT jint JNICALL Java_com_tr_SerailPort_SerialPortJNI_close485Dev(
		JNIEnv *env, jobject thiz, jobject mfd){
	return Java_com_tr_SerailPort_SerialPortJNI_closeDev(env ,thiz, mfd);
}
